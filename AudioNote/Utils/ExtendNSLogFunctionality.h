...
void RecordLoginWithFunInfo(const char *sourceFile, int lineNumber, const char *functionName, NSString *funName, NSString *actName, NSString *actObj, NSDictionary *actRet);
void RecordLogSynced();
#define ActionLogRecord(funName, actName, actObj, actRet) RecordLoginWithFunInfo(__FILE__, __LINE__, __PRETTY_FUNCTION__, funName, actName, actObj, actRet);
