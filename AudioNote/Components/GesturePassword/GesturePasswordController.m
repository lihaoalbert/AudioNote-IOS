...
- (void)viewDidLoad {
    ...
    NSString *gesturePasswordPath = [FileUtils dirPath:CONFIG_DIRNAME FileName:GESTURE_PASSWORD_CONFIG_FILENAME];
...
- (void)enterMainView {
    ...
    self.view.window.rootViewController         = containerController;
